...
/**
 * Represents a geographic location for a client in the system. This class models the data exchanged between the client
 * and the "test" database in MongoDB. It stores client identifiers along with their current geographic coordinates.
 */
@Document("test")
public class Location {

    /**
     * The unique identifier for the location record, automatically assigned by MongoDB.
     * It also encodes the creation timestamp. "@Id" annotation indicates this field is the primary key in the database.
     */
    @Id
    private Object id;

    /**
     * A unique identifier (UUID) for the client session, ensuring that each session is uniquely tracked.
     */
